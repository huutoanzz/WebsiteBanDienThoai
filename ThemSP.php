...
<?php
    ...
    if(isset($_POST["btnSubmit"])){
        ...
        // Đường dẫn tương đối của hình ảnh sau khi tải lên
        $hinh = $duongdan . $hinh_name;

        // Kiểm tra nếu có tệp hình ảnh được tải lên
        if(move_uploaded_file($_FILES["image"]["tmp_name"], $hinh)){
            // Nếu di chuyển tệp thành công, thêm thông tin sản phẩm vào CSDL
            $sql = "INSERT INTO san_pham (ma_loai, ten_sp, nd_tom_tat, don_gia, hinh) VALUES(?,?,?,?,?)";
            $param = array($ma_loai, $ten_sp, $nd_tom_tat, $don_gia, $hinh_name);
            ...
            if($kq){
                ...
                $tb = "Thêm sản phẩm không thành công";
            }
        } else {
			...
			<div class="col-9">
				...
				<form method="post" action="ThemSP.php" enctype="multipart/form-data">
					<div class="form-group">
						<label>Mã loại</label>
						<input type="text" class="form-control" placeholder="Nhập mã loại" name="txtCategory" id="idCategory" required="required"/>
					</div>
					<div class="form-group">
						<label>Tên sản phẩm</label>
						<input type="text" class="form-control" placeholder="Nhập tên sản phẩm" name="txtProductName" id="idProductName" required="required"/>
					</div>
					<div class="form-group">
						<label>Nội dung tóm tắt</label>
						<input type="text" class="form-control" placeholder="Nhập nội dung tóm tắt" name="txtSummary" id="idSummary" required="required"/>
					</div>
					<div class="form-group">
						<label>Đơn giá</label>
						<input type="text" class="form-control" placeholder="Nhập đơn giá" name="txtPrice" id="idPrice" required="required"/>
					</div>
					<div class="form-group">
						<label>Hình</label>
